...
public final class ItemMessageBinding implements ViewBinding {
  ...
  private ItemMessageBinding(@NonNull ConstraintLayout rootView, @NonNull TextView txtContent,
      @NonNull TextView txtUser) {
  ...
  public static ItemMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageBinding((ConstraintLayout) rootView, txtContent, txtUser);
    }
