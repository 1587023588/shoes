...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull LinearLayout rootView, @NonNull ImageView cover,
      @NonNull TextView price, @NonNull TextView stock, @NonNull TextView title) {
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.stock;
      TextView stock = ViewBindings.findChildViewById(rootView, id);
      if (stock == null) {
        break missingId;
      }
      ...
      return new ItemProductBinding((LinearLayout) rootView, cover, price, stock, title);
    }
