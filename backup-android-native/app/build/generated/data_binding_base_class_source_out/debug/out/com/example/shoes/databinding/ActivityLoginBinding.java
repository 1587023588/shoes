...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull LinearLayout rootView, @NonNull ImageView btnClose,
      @NonNull Button btnLogin, @NonNull EditText editPassword, @NonNull EditText editUsername,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((LinearLayout) rootView, btnClose, btnLogin, editPassword,
          editUsername, progress);
    }
