...
public final class FragmentMineBinding implements ViewBinding {
  ...
  private FragmentMineBinding(@NonNull ScrollView rootView, @NonNull ImageView avatar,
      ...
      @NonNull LinearLayout userCard, @NonNull TextView versionText) {
  ...
  public static FragmentMineBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.userCard;
      LinearLayout userCard = ViewBindings.findChildViewById(rootView, id);
      if (userCard == null) {
        break missingId;
      }
      ...
      return new FragmentMineBinding((ScrollView) rootView, avatar, btnSettings, nickname, orderAll,
          ...
          statSupport, statsCard, storyEntry, subtitle, userCard, versionText);
    }
